...
export const ROUTE_POLICIES: readonly RoutePolicy[] = [
  ...
  { path: "/customers/new", allowedRoles: ["operations", "admin"] },
  { path: "/customers/:tenantId/onboarding", allowedRoles: ["operations", "admin"] },
  { path: "/incidents", allowedRoles: ["read_only", "operations", "admin"] },
  { path: "/alerts", allowedRoles: ["read_only", "operations", "admin"] },
  { path: "/alerts/:alertId", allowedRoles: ["read_only", "operations", "admin"] },
  { path: "/digests", allowedRoles: ["operations", "admin"] },
