...
class GoogleMailClient:
    ...
    def get_message(self, message_id: str) -> dict[str, Any]:
        ...
        return {
            ...
            "reply_to": self._extract_header(hdrs, "Reply-To"),
            "sender": self._extract_header(hdrs, "Sender"),
            "return_path": self._extract_header(hdrs, "Return-Path"),
            "subject": self._extract_header(hdrs, "Subject"),
            "internet_message_id": self._extract_header(hdrs, "Message-ID"),
            "in_reply_to": self._extract_header(hdrs, "In-Reply-To"),
            "references": self._extract_header(hdrs, "References"),
