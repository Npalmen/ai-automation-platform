"""Pause all automatic actions for TENANT_LIVE_EVAL after core campaign."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Pause live-eval automatic Gmail core automation")
