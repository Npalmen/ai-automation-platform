"""Activate temporary lead+customer_inquiry=auto for automatic Gmail core."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Seed automatic Gmail core tenant automation")
    ...
    active = activate_core_automation(args.tenant_id)
    print(
        json.dumps(
            {
                "mode": "apply",
