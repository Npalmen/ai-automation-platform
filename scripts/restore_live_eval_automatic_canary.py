"""Restore TENANT_LIVE_EVAL automation config after automatic Gmail canary."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Restore live-eval tenant automation config")
