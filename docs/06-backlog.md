...
- [x] **Production pilot P1 — observability fix** — live daily report, ground-truth reviews, operational evaluator, runtime readiness; migration 025; `PRODUCTION_PILOT_P1_OPERATIONAL_READY`; PR #112+#113 @ `86c32f1`; plan `docs/plans/production-pilot-p1-observability-fix-plan.md`.
