...
- [ ] **Kapitel 2F.2 — Live Gmail Transport Testbot** (live Gmail intake/reply transport; still gated; builds on 2F.1 foundation).
- [ ] **Kapitel 2F.3+ — Live LLM E2E** (optional live LLM execution; runtime provenance in harness reports).
